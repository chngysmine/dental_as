            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                  ...
                  <br />
                  <span className="bg-gradient-to-r from-primary to-primary/78 bg-clip-text text-transparent">questions</span>
                  <br />
                  <span className="bg-gradient-to-br from-foreground via-foreground to-foreground/70 bg-clip-text text-transparent">answered</span>
                  <br />
                  <span className="bg-gradient-to-br from-foreground via-foreground to-foreground/70 bg-clip-text text-transparent">instantly</span>
                </h1>
                {/* SUBTITLE */}
