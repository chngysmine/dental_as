...
if (!apiKey) {
  ...
  if (!apiKey.startsWith("re_")) {
    ...
    console.error("❌ RESEND_API_KEY appears to be too short. Please verify it's correct.");
  } else {
...
const resend: Resend | null = apiKey && apiKey.startsWith("re_") ? new Resend(apiKey) : null;
