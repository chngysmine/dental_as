        ...
        <div className="mb-12 overflow-hidden">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between bg-gradient-to-r from-[#2b1811] via-[#1e120e] to-[#140c0a] rounded-3xl p-10 border border-[#3b241b] shadow-[0_20px_60px_-25px_rgba(0,0,0,0.8)]">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#3a241a] rounded-full border border-[#4a2e22] text-[#e7a36e] shadow-sm">
            ...
            <div className="hidden lg:block">
              <div className="w-32 h-32 bg-gradient-to-br from-[#eaa36f]/70 via-[#e78a53]/60 to-[#d86c34]/40 rounded-full flex items-center justify-center shadow-[0_10px_40px_-18px_rgba(231,138,83,0.8)]">
                <CrownIcon className="w-16 h-16 text-[#e78a53]" strokeWidth={1.5} />
              </div>
            </div>
          </div>
        </div>
                    ...
                    <button
                      ...
                      className={`w-full rounded-md py-2 font-semibold transition ${
                        isActive
                          ...
                          : "bg-[#e78a53] text-white hover:brightness-110"
                      }`}
                    >
